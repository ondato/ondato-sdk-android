...
```
dependencies {
    implementation "com.kyc.ondato:sdk:2.6.6"
}
```         
...
- `implementation "com.kyc.ondato:recorder:2.6.6"` - for screen recording
- `implementation "com.kyc.ondato:nfc-reader:2.6.6"` - for NFC tag scanning
