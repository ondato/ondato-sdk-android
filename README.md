...
```
dependencies {
    implementation "com.kyc.ondato:sdk:2.6.5"
}
```         
...
- `implementation "com.kyc.ondato:recorder:2.6.5"` - for screen recording
- `implementation "com.kyc.ondato:nfc-reader:2.6.5"` - for NFC tag scanning
