...
```
dependencies {
    implementation "com.kyc.ondato:sdk:2.6.3"
}
```         
...
- `implementation "com.kyc.ondato:recorder:2.6.3"` - for screen recording
- `implementation "com.kyc.ondato:nfc-reader:2.6.3"` - for NFC tag scanning
